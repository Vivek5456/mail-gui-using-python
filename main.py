...
#Main Screen Init
master       = Tk()
master.title = 'MAIL GUI Project by Vivek Kumar'
...
#Labels
Label(master, text="Mail GUI project by Vivek Kumar", font=('Calibri',15)).grid(row=0, sticky=N)
...
Button(master, text = "Reset", command = reset).grid(row=7,column=1,  sticky=W,  padx=45, pady=40)
